...
class AppDelegate: UIResponder, UIApplicationDelegate, UITabBarControllerDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Pelorus", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Pelorus.sqlite")
        ...
        if coordinator!.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: url, options: nil, error: &error) == nil {
            ...
            dict[NSLocalizedDescriptionKey] = "Failed to initialize the application's saved data, purging."
            dict[NSLocalizedFailureReasonErrorKey] = failureReason
            dict[NSUnderlyingErrorKey] = error
            error = NSError(domain: "Perolus.FirstChance", code: 9999, userInfo: dict as [NSObject : AnyObject])
